...
See `docs/reference/SOURCE_AWARE_SCHEMA.md` for the review flow.
...
All update scripts are dry-run by default and require `--apply` for writes. See `docs/reference/REVIEW_ACTIONS.md`.
...
The apply script refuses real batches and requires fake labels. Rollback is dry-run by default. See `docs/reference/CANONICAL_MERGE_WORKFLOW.md`.
...
no duplicate merge. See `docs/PHASE_LOG.md`.
...
No outreach is sent in this phase. See `docs/reference/CANONICAL_CONTACT_REVIEW.md`.
...
See `docs/reference/PROPERTY_RELATIONSHIP_PIPELINE.md`.
...
See `docs/reference/PROPERTY_HINT_TO_RELATIONSHIP_WORKFLOW.md`.
...
See `docs/reference/OWNER_BUILDING_UNIT_DASHBOARD.md`.
...
queued, 6 duplicate-involved deferred). See `docs/PHASE_LOG.md`.
...
`scripts/human_dashboard_summary.py`. See `docs/reference/NOCODB_HUMAN_DASHBOARD_RUNBOOK.md`.
...
See `docs/reference/GROWTH_SEO_LEAD_PIPELINE.md`.
...
See `docs/reference/RERA_VERIFICATION_PIPELINE.md`.
...
See `docs/reference/RERA_PLAYWRIGHT_FETCH_FEASIBILITY.md`.
...
`docs/reference/RERA_PLAYWRIGHT_FETCH_FEASIBILITY.md`.
...
See `docs/PHASE_LOG.md`. Next: **human review** of the parser
...
See `docs/PHASE_LOG.md`. Next: **profile verification + match acceptance**
...
See `docs/PHASE_LOG.md`. Next: confirm project name/RERA → landing-page
...
See `docs/PHASE_LOG.md`. Next: confirm project name → contact
...
See `docs/PHASE_LOG.md`. Next: human permission +
...
See `docs/PHASE_LOG.md`. Next: n8n workflow dry-run planning,
...
See `docs/PHASE_LOG.md`. Next: human blueprint approval, then a
...
See `docs/PHASE_LOG.md`. Next: work the blocker/review queues; activation
...
`scripts/revert_dlf_consent_privacy_readiness.py`. See `docs/PHASE_LOG.md`.
...
dlf-westpark-andheri-west --real-ok`. See `docs/PHASE_LOG.md`.
