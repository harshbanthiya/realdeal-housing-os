  ...
  return (
    <aside className="flex w-60 shrink-0 flex-col border-r border-mist-deep bg-mist/30">
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-4 text-sm">
        ...
        <Link
          href="/cockpit/seo"
          className={`mt-0.5 flex items-center gap-2 rounded-lg px-3 py-2 font-medium ${path === "/cockpit/seo" ? "bg-white text-teal shadow-[0_0_0_1px_var(--color-mist-deep)]" : "text-ink/65 hover:bg-white/60"}`}
        >
          SEO
        </Link>
