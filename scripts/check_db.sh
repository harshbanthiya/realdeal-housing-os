...
WITH expected(table_name) AS (
  VALUES
    ...
    ('launch_consent_privacy_review_log'),
    ('launch_contact_permission_evidence'),
    ('launch_contact_suppression_checks'),
    ...
    ('wix_ai_implementation_route_decisions'),
    ('wix_ai_artifact_review_results'),
    ('wix_ai_operator_setup_tasks'),
    ('wix_ai_execution_package_steps'),
    ('wix_ai_implementation_review_items'),
...
WITH expected(view_name) AS (
  VALUES
    ...
    ('vw_dlf_operator_cockpit_home'),
    ('vw_dlf_operator_today_tasks'),
    ('vw_dlf_operator_review_backlog'),
    ('vw_dlf_operator_campaign_calendar_next_14_days'),
    ('vw_dlf_operator_audience_readiness'),
    ('vw_dlf_operator_lead_intake_readiness'),
    ('vw_dlf_operator_n8n_readiness'),
    ('vw_dlf_operator_content_readiness'),
    ('vw_dlf_operator_safety_posture'),
    ('vw_dlf_launch_blocker_triage'),
    ('vw_dlf_project_identity_status'),
    ('vw_dlf_launch_activation_guardrail'),
    ('vw_dlf_consent_privacy_readiness'),
    ('vw_dlf_contact_permission_gap_dashboard'),
    ('vw_dlf_lead_form_privacy_dashboard'),
    ('vw_dlf_suppression_readiness_dashboard'),
    ('vw_dlf_contact_permission_evidence_dashboard'),
    ('vw_dlf_contact_suppression_check_dashboard'),
    ('vw_dlf_contact_permission_decision_dashboard'),
    ('vw_dlf_campaign_selection_guardrail'),
    ...
    ('vw_wix_ai_implementation_route_decision_dashboard'),
    ('vw_wix_ai_artifact_review_dashboard'),
    ('vw_wix_ai_operator_setup_task_dashboard'),
    ('vw_wix_ai_execution_package_step_dashboard'),
    ('vw_wix_ai_implementation_review_queue'),
    ('vw_dlf_wix_ai_implementation_readiness'),
    ('vw_wix_ai_setup_availability_dashboard'),
